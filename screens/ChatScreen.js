      ...
      <View style={styles.container}>
        {
          ...
          <View>
            <Image
              ...
              source={{ uri: `https://firebasestorage.googleapis.com/v0/b/cp4210-221812.appspot.com/o/${this.imageURL(this.state.imageEmail)}?alt=media&token=f3799376-b81e-4485-a557-6182fbc51292` }}
            />
            ...
            this.state.messages.map(m =>
              <Text style={{ fontSize: 20 }} key={m.id}>
                <Image
                  ...
                  source={{ uri: `https://firebasestorage.googleapis.com/v0/b/cp4210-221812.appspot.com/o/${this.avatarURL(m.username)}?alt=media&token=f3799376-b81e-4485-a557-6182fbc51292` }}
                />
